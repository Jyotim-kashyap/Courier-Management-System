                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ !empty($parcel->sender_contact) ? $parcel->sender_contact : "NONE" }}" type="text" name="sender_contact" id="sender_contact" wire:model="sender_contact" class="form-control form-control-sm">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input value="{{ !empty($parcel->recipient_name) ? $parcel->recipient_name : "NONE" }}" type="text" name="recipient_name" id="recipient_name" wire:model="recipient_name" class="form-control form-control-sm">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ !empty($parcel->recipient_address) ? $parcel->recipient_address : "NONE" }}" type="text" name="recipient_address" id="recipient_address" wire:model="recipient_address" class="form-control form-control-sm">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ !empty($parcel->recipient_contact) ? $parcel->recipient_contact : "NONE" }}" type="text" name="recipient_contact" id="recipient_contact" wire:model="recipient_contact" class="form-control form-control-sm">
